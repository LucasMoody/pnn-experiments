...
#
#####################################
def buildPosModel(n_in, embeddings, n_in_case, numHiddenUnitsPOS, pos_n_out, metrics=[], additional_models_for_input=[], useModelInput=False, useHiddenWeights=False):
