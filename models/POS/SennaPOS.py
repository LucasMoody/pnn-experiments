...
def buildPOSModelWithPNN(input_layers, inputs, params, ner_n_out, metrics=[], additional_models=[], name_prefix=''):
    ...
    pos_output_layer = Dense(output_dim=ner_n_out, activation='softmax', name=name_prefix + 'pos_output')
...
def buildPOSModelWithAdapterPNN(input_layers, inputs, params, ner_n_out, metrics=[], additional_models=[], name_prefix=''):
    transfer_model_hidden_layers = []
    transfer_model_output_layers = []
