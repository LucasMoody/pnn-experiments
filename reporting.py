from experiments import exp1, exp_2, exp3, exp_4, exp_5
...
dev_accs_ner_5, test_accs_ner_5, dev_f1s_ner_5, test_f1s_ner_5, ranges_5 = exp_5.buildAndTrainNERModelWithPos()
...
metric_results.append((dev_f1s_ner_5, ranges_5, 'ner_dev_f1_5'))
metric_results.append((test_f1s_ner_5, ranges_5, 'ner_test_f1_5'))
