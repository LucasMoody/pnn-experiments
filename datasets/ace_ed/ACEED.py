...
def readDataset(windowSize, word2Idx, case2Idx):
    ...
    events_train_sentences = GermEvalReader.readFile(events_trainFile, 0, label_position)
    events_dev_sentences = GermEvalReader.readFile(events_devFile, 0, label_position)
    events_test_sentences = GermEvalReader.readFile(events_testFile, 0, label_position)
