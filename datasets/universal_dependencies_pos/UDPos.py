...
def readDatasetExt(windowSize, word2Idx, case2Idx):
    ...
    input_train = [pos_train_x, pos_train_ner_x, pos_train_casing_x]
    input_dev = [pos_dev_x, pos_dev_ner_x, pos_dev_casing_x]
    input_test = [pos_test_x, pos_test_ner_x, pos_test_casing_x]

    pos_train_y_cat = np_utils.to_categorical(pos_train_y, len(pos_label2Idx))

    dicts = [word2Idx, pos_ner2Idx, case2Idx, pos_label2Idx, pos_idx2Label]
